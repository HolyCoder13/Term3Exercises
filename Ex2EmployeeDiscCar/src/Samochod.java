...
public class Samochod {
    ...
    public void zatankuj(double zatankowane){
        if(this.pojemnoscZbiornika+zatankowane>=pojemnoscZbiornika)
            this.stanPaliwa= (int)pojemnoscZbiornika;
        else this.stanPaliwa+=zatankowane;
    }

    public void zatankujDoPelna(){
        this.stanPaliwa=(int)this.pojemnoscZbiornika;
    }
    public boolean czyPusty(){
        return this.stanPaliwa>0;
    }
    ...
    public void jedz(int przejechane){
        this.przebieg+=przejechane;
        this.stanPaliwa-=(this.spalanie*przejechane*100);
    }
    public void zatrzymajSie(){
        this.predkoscAktualna=0;
    }
    public void wykonajTuning(int predkoscDodana){
        this.predkoscMaksymalna+=predkoscDodana;
    }

    public boolean czyStarszy(Samochod porownywany){
        return this.rocznik<porownywany.rocznik;
    }
